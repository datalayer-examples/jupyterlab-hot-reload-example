...
ENV_NAME=jupyterlab-hot-reload
...
publish: clean build ## publish
	npm publish
	echo open https://www.npmjs.com/package/@datalayer/jupyterlab-hot-reload
...
publish-typedoc: typedoc ## deploy typedoc
	aws s3 rm \
		s3://datalayer-typedoc/datalayer/jupyterlab-hot-reload/0.0.1/ \
		--recursive \
		--profile datalayer
	aws s3 cp \
		typedoc \
	...
	aws cloudfront create-invalidation \
		--distribution-id XXX \
		--paths /datalayer/jupyterlab-hot-reload/0.0.1/ \
		--profile datalayer
	echo open ✨  https://typedoc.datalayer.tech/datalayer/jupyterlab-hot-reload/0.0.1
