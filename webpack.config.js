...
const publicPath = IS_PRODUCTION ? "/static/jupyterlab_hot_reload/" : "http://localhost:3063/";
const entry = process.env.HMR ? "./src/HotReloadAppHmr" : "./src/HotReloadApp";
...
//    usedExports: true,
  ...
  output: {
    publicPath,
//    filename: '[name].[contenthash].jupyterlab-hot-reload.js',
    filename: '[name].jupyterlab-hot-reload.js',
  },
  resolve: {
